...
import { User, FileText, FolderKanban, BookOpen, Mail, Sun, Moon, Briefcase, MessageSquare } from "lucide-react";
...
const Sidebar = ({ activeSection, onSectionChange }: SidebarProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Navigation */}
      <ul
        className="flex-1 px-2 list-none md:px-[11px] flex-col flex items-center justify-start gap-[8px] border-none rounded-md shadow-none overflow-y-auto custom-scrollbar"
        role="menubar"
      >
        {navItems.map((item) => (
          <li key={item.id} role="none">
            ...
            >
              ...
              <span className="text-[10px] md:text-xs font-medium relative z-10">
                {item.label}
              </span>
            </Link>
          </li>
