...
const socialLinks = [{
  icon: BehanceIcon,
  href: "https://www.behance.net/abdullahaljamil1",
  label: "Behance"
}, {
  icon: Instagram,
  href: "https://www.instagram.com/al.jamil.9022?igsh=MWViYXdhNGQ3NGMzdg==",
  label: "Instagram"
}, {
  icon: Facebook,
  href: "https://www.facebook.com/share/1AAiyinQkK/",
  label: "Facebook"
}, {
  icon: Linkedin,
  href: "https://www.linkedin.com/in/al-jamil-b817442a2/",
  label: "LinkedIn"
}];
    ...
    duration: 0.5
      ...
      <div className="relative -mt-14 md:-mt-16 flex-row flex items-start justify-center">
        ...
        duration: 0.4
          ...
          <div className="w-24 h-24 md:w-28 md:h-28 rounded-2xl overflow-hidden border-4 border-card shadow-xl">
            <img src={abdullahPortrait} alt="Abdullah Al Jamil" className="w-full h-full object-cover" />
          </div>
          {/* Online indicator */}
      ...
      <div className="p-5 md:p-6 text-center flex-1 flex flex-col py-[23px]">
        ...
        duration: 0.4
          ...
          {socialLinks.map(social => <a key={social.label} href={social.href} target="_blank" rel="noopener noreferrer" className="social-icon-btn p-2.5 rounded-xl bg-secondary/50 text-muted-foreground transition-all duration-300" aria-label={social.label}>
